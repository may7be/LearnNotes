...
import demo.com.debugutil.bean.StorageInfo;
...
public class SDCardUtils {
        ...
        if (file.exists() || file.isDirectory()) {
            ...
            for (String aTempList : tempList) {
                if (dir.endsWith(File.separator)) {
                    temp = new File(dir + aTempList);
                } else {
                    temp = new File(dir + File.separator + aTempList);
                }
    ...
    public static List<StorageInfo> listAvailableStorage() {
        ...
        StorageManager storageManager = (StorageManager) BaseUtil.getContext().getSystemService(Context.STORAGE_SERVICE);
        try {
            Class<?>[] paramClasses = {};
