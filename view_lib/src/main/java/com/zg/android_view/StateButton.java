...
public class StateButton extends AppCompatButton {
    ...
    public StateButton(Context context) {this(context, null);
    }
...
//        states[4] = new int[]{android.R.attr.state_window_focused};
        ...
        int mDefaultNormalTextColor = mTextColorStateList.getColorForState(states[3], getCurrentTextColor());
        int mDefaultPressedTextColor = mTextColorStateList.getColorForState(states[1], getCurrentTextColor());
        int mDefaultUnableTextColor = mTextColorStateList.getColorForState(states[4], getCurrentTextColor());
        ...
        mDuration = a.getInteger(R.styleable.StateButton_animDuration, mDuration);
        ...
        mStateBackground.addState(states[2], mPressedBackground);
        mStateBackground.addState(states[3], mNormalBackground);
        mStateBackground.addState(states[4], mUnableBackground);
    ...
    private void setTextColor() {
        int[] colors = new int[]{mPressedTextColor, mPressedTextColor, mPressedTextColor, mNormalTextColor, mUnableTextColor};
