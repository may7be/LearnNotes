...
public class VerticalTabLayout extends ScrollView implements View.OnClickListener {
	...
	public interface OnTabSelectedListener {
		...
		void onTabReleased(Tab tab, int position);
	}
	...
	/**
	 * Create and return a new {@link Tab}. You need to manually addToFirst this using
	...
	private class TabStrip extends LinearLayout {
		...
		private LayoutParams createLayoutParamsForTabs() {
			final LayoutParams lp = new LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT,
