...
public final class RomUtils {
    ...
    public static boolean isNubia() {
        Log.e("rom_util", "rom name: " + getRomInfo().name);
    ...
    public static RomInfo getRomInfo() {
        ...
        Log.e("rom_util", "brand: " + brand + ",manufacturer: " + manufacturer);
    ...
    private static boolean isRightRom(final String brand, final String manufacturer, final String... names) {
        ...
        for (String name : names) {
            if (!TextUtils.isEmpty(brand) && brand.contains(name)) {
                return true;
            }
            if (!TextUtils.isEmpty(manufacturer) && manufacturer.contains(name)) {
                return true;
            }
        }
        return false;
